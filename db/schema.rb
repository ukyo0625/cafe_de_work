...
ActiveRecord::Schema.define(version: 2020_07_10_094206) do
  ...
  create_table "shops", force: :cascade do |t|
    ...
    t.text "shop_detail", default: "", null: false
    t.integer "owner_id", null: false
    t.string "address", default: "", null: false
    t.integer "seat", null: false
    t.string "open_time", default: "", null: false
    t.string "close_time", default: "", null: false
